...
!(function (a) {
  ...
  var _ = a("#contact-form"),
    H = a("#subscribe-form");
  if (_.length > 0 || H.length > 0) {
    ...
    if (_.length > 0) {
      var V = _.find("select.required"),
        U = _.find(".form-results");
      _.validate({
    ...
    if (H.length > 0) {
      var B = H.find(".subscribe-results");
      H.validate({
        invalidHandler: function () {
          B.slideUp(400);
        },
  ...
  var O = "../ico/";
  i.hasClass("is-rtl") && (O = "../../ico/"),
    i.append(
      '<div class="promo-content"><a href="#" class="promo-close"><em class="ti ti-close"></em></a><a target="_blank" href="http://bit.ly/2r1v4mN" class="promo-content-wrap"><div class="promo-content-img"><img src="' +
        O +
        'images/tokenwiz.jpg" alt="TokenWiz"></div><div class="promo-content-text"><h5>Check out new <br><span>User Dashboard</span> <br>with Admin Feature</h5><p>New &amp; modern look!</p></div></a></div><a target="_blank" href="http://bit.ly/2r1v4mN" class="promo-trigger"><div class="promo-trigger-img"><img src="' +
        O +
        'images/tokenwiz-icon.png" alt="TokenWiz"></div><div class="promo-trigger-text">Looking for new <br>ICO Dashboard?</div></a>'
    );
  var F = a(".promo-trigger"),
    M = a(".promo-content"),
    N = a(".promo-close");
  N.length > 0 &&
    N.on("click", function () {
      ...
      return (
        ...
        F.addClass("active"),
        null == a && Cookies.set("twz-offer", "true", { expires: 1, path: "" }),
        !1
      );
    }),
    e.on("load", function () {
  ...
  i.hasClass("is-rtl") &&
    ...
    a(".demo-themes,.demo-close").on("click", function () {
      a(".demo-theme-content").toggleClass("active"),
        a("html").toggleClass("demo-on");
    }),
    a(".demo-toggle").on("click", function () {
      a(".demo-content").slideToggle("slow");
    });
  var K = a(".color-trigger");
  K.length > 0 &&
    K.on("click", function () {
  ...
  X.length > 0 &&
    e.on("load", function () {
      q.fadeOut(300), i.addClass("loaded"), X.delay(700).fadeOut(300);
    });
  var G = ".slider-pane";
  if (a(G).length > 0) {
    var Z = !!i.hasClass("is-rtl");
    a(G)
  ...
  $.length > 0 &&
    $.each(function () {
      a(".card-header a").on("click", function () {
        var e = a(this);
        e.parent().parent().parent().parent().find($).removeClass("active"),
          e.parent().parent().parent().addClass("active");
      });
    });
  var aa = a("#particles-js"),
    ea = "#2b56f5",
    ia = "#000";
  i.hasClass("io-zinnia") && ((ea = "#fff"), (ia = "#fff")),
    aa.length > 0 &&
