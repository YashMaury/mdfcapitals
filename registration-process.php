...
{
redirect('introducer?msg=4&id='.$id.'&intr='.trim($_POST['sponsor']));
}else{
redirect('ref?msg=4&id='.$id);
}
...
if($_REQUEST['case']=='introducer')
{
redirect('introducer?intr='.trim($_POST['sponsor']).'&e=1');
}else{
redirect('ref?reg='.trim($_POST['sponsor']).'&e=1');
}
}
}else{
...
if($_REQUEST['case']=='introducer')
{
redirect('introducer?intr='.trim($_POST['sponsor']).'&q=4');
}else{
redirect('ref?reg='.trim($_POST['sponsor']).'&q=4');
}
