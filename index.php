...
<body class="theme-dark io-zinnia" data-spy="scroll" data-target="#mainnav" data-offset="80">
    ...
    <header class="site-header is-sticky">
        ...
        <div id="header" class="banner banner-zinnia">
            <!--<div class="circlebg1"><img class="img-fluid" src="assets/images/circlebg19.svg" alt="img"></div>
            <div class="circlebg2"><img class="img-fluid" src="assets/images/circlebg20.svg" alt="img"></div>
            <div class="circlebg3"><img class="img-fluid" src="assets/images/circlebg21.svg" alt="img"></div>-->
    ...
    <div class="gaps size-6x d-md-none" style="background:#02060a !important"></div>
    <div class="gaps size-3x" style="background:#02060a"></div>
    <!-- End Header --><!-- Start Section -->
    <div class="section section-pad about-section no-pb section-bg" id="about" style="display:none;">
        <div class="container">
    ...
    <div class="section payments  section-pad section-bg" id="why">
        <div class="ui-shape ui-shape-s1"></div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-last coinbox">
                    <img src="images/pasa2.png" />
                </div>
    ...
    <!-- End Section --><!-- Start Section -->
    <div class="section section-pad prblmsltn-section section-bg-alt pt-0" id="benifits">
    ...
    <!-- End Section --><!-- Start Section -->
    <div class="section section-pad section-bg pt-0" id="why">
    ...
    <!-- End Section --><!-- Start Section -->
    <div class="section section-pad token-alocate-section section-bg pb-5" id="tokenAlocate">
        ...
        <div class="container">
            ...
            <div class="tab-s4">
                ...
                <div class="gaps size-2x" style="background:none;"></div>
    ...
    <div class="section section-pad section-bg " id="why" style="z-index: 6;
background: #02060a;
padding-top: 67px;
padding-bottom: 60px;">
    ...
    <div class="section section-pad document-section section-bg-zinnia" id="documents" style="z-index:6; display:none;">
        <div class="container">
                    ...
                    <div class="row justify-content-between text-center text-lg-left">
                        ...
                        <div class="col-xl-5 col-md-6">
                            <div class="service-item animated" data-animate="fadeInUp" data-delay=".6">
                                <div class="service-icon mx-auto mx-lg-0"><img src="Asset 2.png" alt="icon"></div>
                                <h5 class="service-title">World Coverage</h5>
                                <p>World Coverage- Providing services in 99% countries around the globe</p>
                            </div>
                        </div>
                        <!-- .col -->
                        <div class="col-xl-5 col-md-6">
    ...
    <!-- Start Section -->
    <div class="section section-pad section-bg-zinnia" id="partners" style="display:none;">
        <div class="container">
            <div class="row text-center">
            ...
            <div class="partner-list">
                ...
                <!--<div class="row text-center">
                  <div class="col-md-10 offset-md-1">
                    <div class="row">
                      <div class="col-sm col-6">
                        <div class="single-partner animated" data-animate="fadeInUp" data-delay=".8"><img src="images/partner-sm-light-a.png" alt="partner"></div>
                      </div>
                      <div class="col-sm col-6">
                        <div class="single-partner animated" data-animate="fadeInUp" data-delay=".9"><img src="images/partner-sm-light-b.png" alt="partner"></div>
                      </div>
                      <div class="col-sm col-6">
                        <div class="single-partner animated" data-animate="fadeInUp" data-delay="1"><img src="images/partner-sm-light-c.png" alt="partner"></div>
                      </div>
                      <div class="col-sm col-6">
                        <div class="single-partner animated" data-animate="fadeInUp" data-delay="1.1"><img src="images/partner-sm-light-d.png" alt="partner"></div>
                      </div>
                    </div>
                  </div>
                </div>-->
                ...
                <div class="col-md-10">
                    <div class="tab-custom-s3">
                        ...
                        <!--<ul class="nav nav-tabs text-center justify-content-center animated" data-animate="fadeInUp" data-delay=".1">
                          ...
                          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-2">Pre-ICO &amp; ICO</a></li>
    ...
    <div class="section section-pad-md section-bg-alt" id="contact">
        ...
        <div class="container">
            ...
            <!--<div class="row justify-content-center">
              <div class="col-lg-8">
                <form id="contact-form" class="form-message text-center show-error-hint" action="http://demo.themenio.com/ico/form/contact.php" method="post">
