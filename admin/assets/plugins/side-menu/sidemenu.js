...
$(window).resize(() => {
  ...
  if ($("body").hasClass("ltr")) {
    if (
      ...
      sideMenu
        .stop(false, true)
        .animate({ marginLeft: -check }, { duration: 400 });
    } else {
      sideMenu.stop(false, true).animate({ marginLeft: 0 }, { duration: 400 });
    }
  } else {
    if (
      ...
      sideMenu
        .stop(false, true)
        .animate({ marginRight: -check }, { duration: 400 });
    } else {
      sideMenu.stop(false, true).animate({ marginRight: 0 }, { duration: 400 });
    }
  }
  checkHoriMenu();
  responsive();
  ...
  if (
    (window.innerWidth >= 992 && prevValue < 992) ||
...
function ActiveSubmenu() {
  ...
  $(".app-sidebar li a").each(function () {
    ...
    setTimeout(() => {
      if (
        (window.innerWidth < 992 && prevValue > 992) ||
        document.querySelector("body").classList.contains("horizontal") != true
      ) {
        if (pageUrl) {
          if (position[position.length - 1] == pageUrl) {
            $(this).addClass("active");
...
$(document).on("click", ".ltr #slide-left", function () {
  ...
  if (marginLeftValue < 0) {
    sideMenu
      .stop(false, true)
      .animate({ marginLeft: "+=" + slide }, { duration: 400 });
...
$(document).on("click", ".ltr #slide-right", function () {
  ...
  if (marginLeftValue > -check) {
    sideMenu
      .stop(false, true)
      .animate({ marginLeft: "-=" + slide, marginRight: 0 }, { duration: 400 });
  } else {
    sideMenu
      .stop(false, true)
      .animate({ marginRight: 0, marginLeft: -check }, { duration: 400 });
    $("#slide-right").addClass("d-none");
  }
  if (marginLeftValue != 0) {
    $("#slide-left").removeClass("d-none");
...
$(document).on("click", ".rtl #slide-left", function () {
  ...
  if (marginRightValue < 0) {
    sideMenu
      .stop(false, true)
      .animate({ marginLeft: 0, marginRight: "+=" + slide }, { duration: 400 });
    if (menuWidth?.offsetWidth - menuContainerWidth < menuItems.scrollWidth) {
      $("#slide-right").removeClass("d-none");
    }
  } else {
...
$(document).on("click", ".rtl #slide-right", function () {
  ...
  if (marginRightValue > -check) {
    ...
    sideMenu
      .stop(false, true)
      .animate({ marginLeft: 0, marginRight: -check }, { duration: 400 });
    $("#slide-right").addClass("d-none");
  }
  if (marginRightValue != 0) {
    $("#slide-left").removeClass("d-none");
