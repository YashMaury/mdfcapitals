...
<?php if(isset($_REQUEST['m'])==1){?><p align="center" style="color:#FFFFFF; padding-bottom:8px; font-size:16px;"><strong>Your account is successfully activated!</strong></p><?php }?>
<br></div>
...
<div class="project-content">
<h6>Invested Member</h6>
<?=getApprovedMember($conn)?>
</div>
</div>
</div>
</div>
...
<div class="project-content">
<h6>Non Invested Member</h6>
<?=getInactiveMember($conn)?>
</div>
</div>
</div>
</div>
