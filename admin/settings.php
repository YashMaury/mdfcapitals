...
<form class="form" action="settings-package-process.php?case=add" autocomplete="off" method="post">
<div class="form-body">
...
?>
<form class="form" action="settings-package-process.php?case=edit&id=<?=$_REQUEST['id']?>" autocomplete="off" method="post">
<div class="form-body">
...
$fetch=fetcharray($res);
?>
<form class="form" action="settings-direct-process.php?case=edit&id=<?=$_REQUEST['id']?>" autocomplete="off" method="post">
<div class="form-body">
...
$fetch=fetcharray($res);
?>
<form class="form" action="settings-level-process.php?case=edit&id=<?=$_REQUEST['id']?>" autocomplete="off" method="post">
<div class="form-body">
<div class="form-group">
...
<form class="form" action="settings-level-process.php?case=add" autocomplete="off" method="post">
<div class="form-body">
<div class="form-group">
<label for="userinput5">Level<span style="color:#CC0000;">*</span></label>
<select name="level" id="level" class="form-control  border-primary" required>
...
$fetch=fetcharray($res);
?>
<form class="form" action="settings-level-roi-process.php?case=edit&id=<?=$_REQUEST['id']?>" autocomplete="off" method="post">
<div class="form-body">
<div class="form-group">
<label for="userinput5">Level<span style="color:#CC0000;">*</span></label>
<select name="level" id="level" class="form-control  border-primary" required>
...
<form class="form" action="settings-level-roi-process.php?case=add" autocomplete="off" method="post">
<div class="form-body">
<div class="form-group">
<label for="userinput5">Level<span style="color:#CC0000;">*</span></label>
<select name="level" id="level" class="form-control  border-primary" required>
...
$fetch=fetcharray($res);
?>
<form class="form" action="settings-withdrawal-process.php?case=edit&id=<?=$_REQUEST['id']?>&page=<?=$_REQUEST['page']?>" autocomplete="off" method="post">
