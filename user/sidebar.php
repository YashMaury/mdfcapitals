 <nav class="navbar navbar-inverse navbar-fixed-top">
                <div class="">
                    <div class="mobile-only-brand pull-left">
                        ...
                        <div class="nav-header pull-left">
                            <div class="logo-wrap">
                                <a href="dashboard">
                                    ...
                                    <img class="brand-img img-responsive" style="margin: 0px auto; max-width: 160px;" src="../cclogo.png" />
                                </a>
                            </div>
                        </div>
                        ...
                        <a id="toggle_nav_btn" class="toggle-left-nav-btn inline-block ml-20 pull-left mobile-only-view" href="javascript:void(0);"><i class="zmdi zmdi-menu"></i></a>



                        <li class="menu-item list-inline-item navmenu " style="list-style: none; display: none;"><a class="navbar-toggle nav-link">
                    ...
                    <div id="ctl00_mobile_only_nav" class="mobile-only-nav ">
                        ...
                        <ul class="nav navbar-right top-nav ">
                            ...
                            <li class="dropdown auth-drp">
                                <a id="ctl00_lbtnLogOutTop" href="javascript:__doPostBack(&#39;ctl00$lbtnLogOutTop&#39;,&#39;&#39;)"><img src="images/users.png" id="ctl00_imgUserDP" alt="user" class="user-auth-img img-circle" style="display: none;" /><img src="images/users.png" alt="user" class="user-auth-img img-circle" /></a>

                                <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                                    <li></li>
                                    <li>
                                        <a href="EditProfile.aspx"><i class="zmdi zmdi-edit "></i><span>Edit Profile </span></a>
                                    </li>
                                    <li>
                                        <a href="ChangePassword.aspx"><i class="zmdi zmdi-email"></i><span>Change Password</span></a>
                                    </li>
                                    <li class="divider"></li>
            ...
            <div class="fixed-sidebar-left ">
                <ul class="nav navbar-nav side-nav nicescroll-bar">
                    <li class="down-list "><a href="dashboard" data-toggle="collapse" data-target="#Main_2121_dr">
                        <div class="pull-left">
                     ...
                     <li class="down-list"><a href="javascript:void(0);" data-toggle="collapse" data-target="#LIQUIDITY">
                        ...
                        <ul id="LIQUIDITY" class="collapse collapse-level-1 two-col-list">
                            <li><a href="invest">New Invest</a></li>
                            <li><a href="my-invest">My Invest</a></li>
                    ...
                    <li class="down-list"><a href="javascript:void(0);" data-toggle="collapse" data-target="#with">
                        ...
                        <ul id="with" class="collapse collapse-level-1 two-col-list">
                            <li><a href="withdraw">Withdraw Request</a></li>
                            <li><a href="my-withdraw">Withdraw Report</a></li>
                    ...
                    <!--</a></li>-->
                     ...
                     <li class="down-list"><a href="javascript:void(0);" data-toggle="collapse" data-target="#app_dr">
                        ...
                        <ul id="app_dr" class="collapse collapse-level-1">
                            <li><a href="det?p=rl">Referral Link</a></li>
                            <li><a href="det?p=md">My Direct Team</a></li>
                            <li><a href="det?p=t">My Team</a></li>
                        </ul>
                    </li>

                    <li class="down-list">
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Tran1">
                            <div class="pull-left"><i class="zmdi zmdi-assignment mr-20"></i><span class="right-nav-text">Earnings</span></div>
                        ...
                        <ul id="Tran1" class="collapse collapse-level-1">
                            ...
                            <li><a href="daily-income">Daily Income </a></li>
                            <li><a href="level-income">Level Income </a></li>
                            <li><a href="reward-income">Reward Income </a></li>
                    ...
                    <li class="down-list">
                        ...
                        <li><a href="det?p=p">Profile</a></li>
                        <li><a href="det?p=ps">Password</a></li>
                    ...
                    <li class="down-list"><a href="support">
                        <div class="pull-left">
                    ...
                    <li class="down-list">
                        <a id="ctl00_lbtnLogout" href="logout">
