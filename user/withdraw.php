...
<?php if($_REQUEST['e']==1){?><p align="center" style="color:#FF0000; padding-bottom:8px;font-size:16px;">Minimum withdrawal amount is <?=getSettingsWithdrawal($conn,'minimum')?></p><?php }?>
<h4 class="form-section" style="color:#000000;" align="center"><i class="icon-wallet"></i>Current Wallet:&nbsp; <?=getAvailableWallet($conn,getMember($conn,$_SESSION['mid'],'userid'))?></h4>
<p>&nbsp;</p>
<?php 
$userid=getMember($conn,$_SESSION['mid'],'userid');
...
<select class="form-control input-pill" id="type" name="type" style="padding:4px;" required>
...
<strong>Please click here to fill up USDT-TRC-20 wallet address!</strong>
</span>
</a></div>
<?php } ?>
