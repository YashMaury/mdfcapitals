...
<?php if($_REQUEST['e']==1){?><div align="center" style="margin:0;padding:0;color:#FF0000; font-size:16px;"><strong>Invalid User ID!</strong></div><?php }?>
...
<?php if($_REQUEST['e']==4){?><p align="center" style="color:#FF0000; padding-bottom:8px;">You cant transfer in your account!</p><?php }?>
<?php if($_REQUEST['m']==1){?><div align="center" style="margin:0;padding:0;color:#00CC00; font-size:16px;"><strong>Your payment succesfully sent to member!</strong></div><?php }?>
<?php if($_REQUEST['e']==5){?><p align="center" style="color:#FF0000; padding-bottom:8px;">Invalid transaction password!</p><?php }?>
