...
<td align="center"><?php if($fetch['status']=='1'){?><a style="color:#009900;">Approved</a><?php }else{?><a style="color:#FF0000;">Pending</a><?php }?></td>
<td align="center"><a href="uploads/receipt/<?=$userid?>/<?=$fetch['receipt']?>" target="_blank" rel="noopener noreferrer">View</a></td>
</tr>
<?php $i++;}}else{?>
