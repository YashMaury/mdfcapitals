        ...
        <div id="header" class="banner banner-zinnia">
            ...
            <div class="container">
                <div class="banner-content">
                    <h1 class="text-center"><u>Legal Document</u></h1>
                    <div class="row align-items-center">
                        
                        <?php
                            $result = getLegalDocument($conn);
                            $num=numrows($result);
                            $i=1;
                            if($num>0){
                                ...
                                <div class="col-md-4 d-flex justify-content-center">
                                    <div class="card" style="width: 18rem;">
                                      <img src="admin/uploads/documents/<?php echo $fetch['image'] ;?>" class="card-img-top"
                                      style="height: 180px; width: 100%; display: block;" alt="...">
                                      <div class="card-body">
                                        <p class="card-text text-dark text-bold"><?php echo $fetch['title'] ;?></p>
                                      </div>
                                    </div>
                                </div>
                                <?php
